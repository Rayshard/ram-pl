...
#line 187 "ramc_bison_parser.hpp"
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, BinopType&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const BinopType& v)
        : Base (t)
        , value (v)
      {}
#endif
